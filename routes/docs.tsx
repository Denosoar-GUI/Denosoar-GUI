      ...
      <div id="docs-body" >
        ...
        <main class="col-span-3 pt-20 px-5" id="docs-main">
          ...
          <p class="mx-auto max-w-screen-md">
            <ul class="mx-auto max-w-screen-md">
              <li>
                <h3 class="section-title">Initializing Denosoar in Your App</h3>
              ...
              <li>
                <h3 class="section-title">Record Memory</h3>
              ...
              <li>
                <h3 class="section-title">Processing .csv Files</h3>
              ...
              <li>
                <h3 class="section-title">Change the Frequency of Data Sampling</h3>
              ...
              <li>
                <h3 class="section-title">Beta - Perform a Simple Load Test</h3>
